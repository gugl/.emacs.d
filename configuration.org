...
#+BEGIN_SRC emacs-lisp
    (use-package elixir-mode
      :config
      ;; This was commented out as it depends on the smartparens package used for ruby and I'm trying a different one at the moment
...
#+RESULTS:
| my-elixir-dialyzer | my-elixir-dialyzer |
